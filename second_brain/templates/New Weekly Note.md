...
// IMPORTANT: The name inside find_tfile() must match your template file name exactly (e.g., "weekly")

// 3. Define the folder where the new file should be created
const folder = "notes/journal/weekly/"; // <-- **CHANGE THIS to your desired folder!**
